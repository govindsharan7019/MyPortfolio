            ...
            <div className='relative      rounded-2xl  mt-20 md:mt-35 ml-0 md:ml-20 w-full md:w-full h-110 md:h-full shrink-0 '>
              ...
              <div className='absolute top-55 md:top-[25vw] left-16 md:left-[6vw] z-10 w-full md:w-full text-white '>
                ...
                <div className='mt-2 md:mt-4'>
                  <p className='leading-5  font-[text2] text-[12px] md:text-[1.2vw] w-31 md:w-[15vw] '>A Computer Science Engineer and web developer passionate about building modern and interactive digital experiences.</p>
                </div>
